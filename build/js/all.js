...
(function (global, factory) {
	...
	ready(function () {
		...
		if (contactButton.length > 0) {
			Array.from(contactButton).forEach(function (el) {
		...
		document.body.onclick = function (e) {
			...
			if (allContacts.length > 0 && e.target.className.indexOf('b-contact__button') === -1 && getClosest(e.target, '.b-card__contacts') === null) {
				Array.from(allContacts).forEach(function (c) {
		...
		if (switches.length > 0) {
			var checkInputsAndAddActiveClass2 = function checkInputsAndAddActiveClass2(e, input, switchText) {
				if (!input) return false;
				if (input.checked) {
			...
			Array.from(switches).forEach(function (e) {
				var input = e.querySelector('.switch__checkbox');
				var switchText = e.querySelector('.switch__header-text');
		...
		/// stick footer bottom
		var stickFooterToBottom = void 0;
		(stickFooterToBottom = function stickFooterToBottom() {
		...
		var showOwe = document.querySelectorAll('.showOwe');
		var owe = document.querySelector('.owe');

		Array.from(showOwe).forEach(function (s) {
			s.onclick = function () {
