...
(function () {
    var picker = new _pikaday.Pikaday({ field: document.getElementById('datepicker1') });
    var picker = new _pikaday.Pikaday({ field: document.getElementById('datepicker2') });
	...
	document.querySelector('.b-contact__button').onclick = function (e) {
...
},{"pikaday":3}],2:[function(require,module,exports){
//! moment.js
